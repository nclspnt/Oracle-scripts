...
sum(TM_DELTA_TIME+TM_DELTA_CPU_TIME+TM_DELTA_DB_TIME)/1000000 TM_DELTA_CPU_DB_TIME,
sum(TM_DELTA_TIME+TM_DELTA_CPU_TIME+TM_DELTA_DB_TIME)/sum(EXECUTIONS_DELTA)/1000000 AVG_ELAPSED_TIME_BY_EXEC,
